# @tetherto/wdk-protocol-confidential-fairblock-evm
...
To install the `@tetherto/wdk-protocol-confidential-fairblock-evm` package, follow these instructions:

You can install it using npm:

```bash
npm install @tetherto/wdk-protocol-confidential-fairblock-evm
```
